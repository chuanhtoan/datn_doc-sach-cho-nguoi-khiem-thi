...
<div class="mdk-header-layout__content top-navbar mdk-header-layout__content--scrollable h-100">
    ...
    <div class="container-fluid">
        ...
        <h2>Bảng Xếp Hạng</h2>
        <p class="lead">
            Quản lý thông tin các bảng xếp hạng.
        </p>
        <hr>
        <div class="card">
            <div class="py-4">
                                ...
                                <tr id="product{{$item->id}}" class="active">
                                    ...
                                    <td>
                                        <div style="display: inline-block">
                                            <a href="/phim_bangxephang/{{$item->id}}" class="btn btn-primary" style="color: white">Show</a>
            ...
            <div class="modal-body">
                <form id="frmProducts" name="frmProducts" class="form-horizontal classFormUpdate validate-form" novalidate="">
                    ...
                    <div class="form-group"> {{--input-group--}}
                        ...
                        <input type="text" name="ten" id="ten" class="form-control required" placeholder="Tên bảng xếp hạng">
                        <p id="textUnique" class="invalid-feedback d-inline text-danger"></p>
                        <input type="hidden" id="idUser" name="idUser" value="{{$nguoidung->id}}">
                    </div>
                </form>
            </div>
...
@section('above_body')
    ...
    {{-- ajax thêm xóa sửa --}}
    @include('pages.bangxephang.ajaxscript')
    @yield('ajax')
