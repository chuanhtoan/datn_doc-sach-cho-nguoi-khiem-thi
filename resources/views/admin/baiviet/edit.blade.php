            ...
            <div class="card-body">
                <form id="frmProducts" name="frmProducts" class="form-horizontal classFormUpdate validate-form" novalidate="" enctype="multipart/form-data" action="{{route('baiviet.store')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="tieuDe-input" value="{{$products->tieuDe}}">
                        <textarea type="textarea" name="tieuDe" id="tieuDe" value="{{$products->tieuDe}}" class="form-control required" placeholder="Tiêu đề bài viết" rows="2"></textarea>
                        <br>
        ...
        $(document).ready(function(){
            ...
            function thucHienAjax(){
                ...
                $.ajax({
                    type: "POST",
                    method:'put',
                    url: '/admin/baiviet/' + $('#product_id').val(),
                    data: formData,
                    dataType: 'json',
